...
<nav id="nav" class="out">
  ...
  <strong class="ribbon-content">Correct! Click continue!</strong>
        ...
        <ul class="quiz-step step1 current">
            ...
            <li class="question">
                <div class="question-wrap">
                    <h2>Question #1: What is the use of Empathy Map?</h2>
                </div>
            </li>
        ...
        <div class="figures" style="text-align:center;padding-top:5px;">0/3</div>
    </div>
    <script>
        $var = "";
...
$(document).ready(function() {
    ...
    $('#submitBtn').click(function() {
        if ($('#btnSubmit').text() == "Submit") {
            ...
            window.location = "/WebApplication1/q2.jsp";
            $('.ribbon-content').html("");
        } else {
            $('.ribbon').fadeOut();
