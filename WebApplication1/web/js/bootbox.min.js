...
!function(a, b) {
    ...
    p.alert = function() {
        ...
        if (g(i, function(a, b) {
            if(b.className.indexOf('continue')>0 || b.className.indexOf('try') > 0){
                j += "<button data-bb-handler='" + a + "' type='button' class='btn " + b.className + "' style='float:left;width:40%;'>" + b.label + "</button>", k[a] = b.callback
            }else{
                j += "<button data-bb-handler='" + a + "' type='button' class='btn " + b.className + "' style='float:right;width:40%;'>" + b.label + "</button>", k[a] = b.callback
            }
