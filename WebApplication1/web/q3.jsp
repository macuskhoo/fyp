...
<body>  <script src="js/jquery-1.8.3.min.js"></script>
        ...
        <ul class="quiz-step step1 current">
            ...
            <li class="question">
                <div class="question-wrap">
                    <h2>Question #3: What is the use of Empathy Map?</h2>
                </div>
            </li>
    ...
    $('#submitBtn').click(function() {
        if ($('#btnSubmit').text() == "Submit") {
            if ($var == "") {
                ...
                $('.bar').css('width','100%');
                $('.figures').html('3/3');
                localStorage.setItem('quiz2', 'done');
                localStorage.setItem('leaderboard1','update1');
            } else {
